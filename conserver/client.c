...
static HELP aHLTable[] = {
    ...
    {WHEN_ATTACH, "Su      serial baud up"},
    {WHEN_ATTACH, "Sd      serial baud down"},
    {WHEN_ATTACH, "Sf      cycle through flow control (RTS/CTS, XON/XOFF, none)"},
    {WHEN_ATTACH, "Sy      cycle through parity settings (even, odd, none)"},
